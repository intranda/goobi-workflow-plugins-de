...
| Details |  |
| :--- | :--- |
| Identifier Workflow Plugin | intranda_workflow_entity_editor |
| Identifier Dashboard Plugin | intranda_dashboard_entity |
| Source code Workflow Plugin| [https://github.com/intranda/goobi-plugin-workflow-entity-editor](https://github.com/intranda/goobi-plugin-workflow-entity-editor) |
| Source code Dashboard Plugin| [https://github.com/intranda/goobi-plugin-dashboard-entity](https://github.com/intranda/goobi-plugin-dashboard-entity) |
...
![Auswahl des korrekten Dashboards für den Nutzer](../.gitbook/assets/intranda_workflow_artist_dictionary_1.png)

Nach der erfolgten Auswahl steht das Dashboard für den Nutzer nach dem Login zur Verfügung:

![Dashboard des Artist Dictionary Plugins](../.gitbook/assets/intranda_workflow_artist_dictionary_2.png)

Von hier aus kann die weitere Bearbeitung der Entitäten erfolgen:

![Workflow-Plugin mit der Bearbeitungsmaske für die Entitäten](../.gitbook/assets/intranda_workflow_artist_dictionary_3.png)
...
```bash
/opt/digiverso/goobi/plugins/dashboard/plugin_intranda_dashboard_entity.jar
/opt/digiverso/goobi/plugins/GUI/plugin_intranda_dashboard_entity-GUI.jar
/opt/digiverso/goobi/plugins/GUI/plugin_intranda_workflow_entity_editor-GUI.jar
/opt/digiverso/goobi/plugins/workflow/plugin_intranda_workflow_entity_editor.jar
```
